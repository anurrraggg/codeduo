                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {
                            testimonials.map((testimonials, index) => (
                                <motion.div key={index} variants={fadeInUp} className={`${testimonials.color}-50 p-8 rounded-2xl`}>
                                    <div className="flex items-center mb-4">
                                        <div className={`w-12 h-12 ${testimonials.color}-200 rounded-full flex items-center justify-center`}>
                                            <span className={`${testimonials.color}-700 font-semibold`}>{testimonials.profile}</span>
                                        </div>
                                        <div className="ml-4">
